...
public class ProcessMemoryFindBytesTest : ProcessMemoryTest
{
    ...
    public void FindBytesWithKnownFixedBytesPatternTest()
    {
        ...
        var results = TestProcessMemory!.FindBytes("4D 79 53 74 72 69 6E 67 56 61 6C 75 65", range).ToList();
    ...
    public void FindBytesWithKnownMaskedBytesPatternTest()
    {
        ...
        var results = TestProcessMemory!.FindBytes("4D 79 ?? ?? ?? ?? ?? ?? 56 61 6C 75 65", range).ToList();
    ...
    public void FindBytesWithKnownPartialMasksBytesPatternTest()
    {
        ...
        var results = TestProcessMemory!.FindBytes("4D 79 53 74 72 69 6E 6? ?6 61 6C 75 65", range).ToList();
